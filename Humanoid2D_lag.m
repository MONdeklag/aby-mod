...
tht6 = [tht6SS2 ; tht6DS1 ; tht6SS1 ; tht6DS2];% thtt6 for diff phase ordered
...
GRFxl = zeros(136,1);
GRFxl(1:68)=sol(1:68,1)+sol(1:68,2);
GRFxl(54:68)=sol(54:68,1);
%GRFxl(69:121)=sol(69:121,1)+sol(69:121,2);
GRFxl(122:136)=sol(122:136,2);
%{
figure;
...
GRFyl = zeros(136,1);
GRFyl(1:68)=sol(1:68,3)+sol(1:68,4);
GRFyl(54:68)=sol(54:68,3);
%GRFxl(69:121)=sol(69:121,1)+sol(69:121,2);
GRFyl(122:136)=sol(122:136,3);
